...
$('.vinyl-wrapper-login').addClass("not-selected");
...
function show_login(){
  ...
  $('.vinyl-wrapper-register').addClass("not-selected");
  $('.vinyl-wrapper-login').removeClass("not-selected");
}
...
function show_register() {
  ...
  $('.sign-up-input').css('display', 'block');
  $('.vinyl-wrapper-login').addClass("not-selected");
  $('.vinyl-wrapper-register').removeClass("not-selected");
}
